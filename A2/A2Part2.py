...
Write a function to generate the complex sinusoid that is used in the DFT computation of length N (samples), 
...
def genComplexSine(k, N):
  ...
  #  x = np.cos( (2*np.pi*k/N)*n )+np.sin( (2*np.pi*k/N)*n )*1j
